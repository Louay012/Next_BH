...
def get_recommendations_list(client_ref):
    ...
    prompt = [
    {
        ...
        "content": (
            ...
            "4. Sélectionner 3 produits de la liste fournie par le tool search_tool en tenant compte du raisonnement et il faut que les caratéristiques du client respectent les exigences et les conditions des produits (je n'accepte pas un produit qui ne respecte pas les conditions du contrat) exempple un produit ou l'age n'accepte pas plus de 40 ans ... ."
