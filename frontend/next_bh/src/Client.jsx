        ...
        if (data.status === "success") {
          ...
          if (typeof recommendationsString === "string") {
            ...
            if (jsonMatch) {
              ...
              setNewRecommendations([recommendationsString]); // Fallback to an array with the string
            }
          } else {
            console.error("recommendationsString is not a string:", recommendationsString);
