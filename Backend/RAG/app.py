...
app = FastAPI(
    title="Assistant IA BH Assurance",
    description="Service de questions-réponses sur documents d'assurance",
    version="1.0.0"
)
...
def get_or_create_vectorstore(file_path: str) -> FAISS:
    ...
    if Path(index_path).exists():
        try:
            ...
            print(f"⚠️ Erreur de chargement FAISS, reconstruction...: {e}")
